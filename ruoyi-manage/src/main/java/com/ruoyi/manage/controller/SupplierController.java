...
public class SupplierController extends BaseController
{
     ...
     * 查询商家管理列表
     */
    @PreAuthorize("@ss.hasPermi('manage:supplier:list')")
    @GetMapping("/list")
     ...
     * 导出商家管理列表
     */
    @PreAuthorize("@ss.hasPermi('manage:supplier:export')")
     ...
     * 获取商家管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('manage:supplier:query')")
     ...
     * 新增商家管理
     */
    @PreAuthorize("@ss.hasPermi('manage:supplier:add')")
     ...
     * 修改商家管理
     */
    @PreAuthorize("@ss.hasPermi('manage:supplier:edit')")
     ...
     * 删除商家管理
     */
    @PreAuthorize("@ss.hasPermi('manage:supplier:remove')")
